...
{{- printf "%s.%s.svc.%s" .Values.headlessServiceName  .Release.Namespace .Values.clusterDomain }}
{{- end}}
...
{{- printf "%s-0.%s.%s.svc.%s" (include "marklogic.fullname" .) .Values.headlessServiceName .Release.Namespace .Values.clusterDomain }}
{{- end}}
